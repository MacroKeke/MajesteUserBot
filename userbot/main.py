...
ALIVE_MSG = [
    "        **Hey {majestesahip} **\n \n✨ Yüklenen Plugin Sayısı {plugin}\n \n👨🏼‍💻 Python Sürümü {python}\n \n⚡️Telethon Sürüm {telethon}\n \nEndişelenme Majeste UserBot'un Sapa Sağlam Çalışıyor iyi günler :)️ <3😼\n\n\n         Majeste Sürüm {majeste} ",
    "🎆 `Endişelenme! Seni yanlız bırakmam.` **{majestesahip}**, MajesteUserbot😼 çalışıyor.` \n Bot Versiyonu: {majeste} ",
    "`⛈️ Elimden gelenin en iyisini yapmaya hazırım`, **{majestesahib}** \n Bot Versiyonu: {majeste} ",
...
UNAPPROVED_MSG = ("`Hey olduğun yerde kal,!👨‍💻 Ben` @majesteuserbot . `Endişelenme!`\n\n"
    ...
    if re.search(r'CmdHelp\(.*\)', FileRead):
        ...
        for Command in Pattern:
            ...
            if not Majestepy == None:
                ...
                for Satir in Majestepy.splitlines():
